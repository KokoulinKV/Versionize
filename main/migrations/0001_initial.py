    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_type', models.IntegerField(blank=True, choices=[(1, 'Площадной'), (2, 'Линейный')], null=True, verbose_name='Тип объекта')),
            ],
            options={
                'verbose_name': 'Проект',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_type', models.IntegerField(blank=True, choices=[(1, 'Площадной'), (2, 'Линейный')], null=True)),
            ],
        ),
    ]
