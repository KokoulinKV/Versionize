...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='section',
            name='company',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.company', verbose_name='Организация'),
        ),
        migrations.AddField(
            model_name='section',
            name='expert',
        ...
        migrations.AddField(
            model_name='comment',
            name='reply_to',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='parent', to='main.comment', verbose_name='Переслать'),
        ),
        migrations.AddField(
